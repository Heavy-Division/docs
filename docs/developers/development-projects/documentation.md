# Heavy Division Documentation Project

 [**Documentation Project Github**](https://github.com/Heavy-Division/docs)

## Background

The Heavy Division Documentation Project aims to provide all necessary information and documentation to successfully install and use the Heavy Division B78XH aircraft in Microsoft Flight Simulator.

For this we provide documentation about the B78XH mod itself but also valuable additional documentation on how to fly an airliner on Microsoft Flight Simulator in general and even some specific B78XH documentation for the more involved user.
...
### Contacts for Heavy Division Documentation Team

If you have questions or suggestions, or if you want to contribute to the Heavy Division Documentation project, please contact us on Discord:

[**Discord Link**](https://discord.gg/Heavy-Division){target=new}
...
To participate in the Heavy Division Documentation Project you need to have following tools installed:

- Github account and Git ([Github Quickstart](https://docs.github.com/en/get-started/quickstart))
...
- Fork the [:fontawesome-brands-github:{: .github } -  **Documentation Project Github**](https://github.com/Heavy Divisionsim/docs){target=new} ([How to fork a repository](https://docs.github.com/en/get-started/quickstart/fork-a-repo){target=new}).
...
- Checkout the "primary" branch - this is the main branch of the current Heavy Division Documentation Project.
...
### How to Write Documentation for Heavy Division
...
- Although the Heavy Division Documentation Team will take care of navigation it might still be of interest how the navigation is done. This is well explained on the [mkdocs-awesome-pages-plugin's README on their Github](https://github.com/lukasgeiter/mkdocs-awesome-pages-plugin#Features){target=new}
...
- Don't hesitate to get feedback from the Heavy Division Documentation Team early and often.
...
Please use Github's Issue tracker for any documentation request or issues you might have encountered.
 ...
 [:fontawesome-brands-github:{: .github } -  **Documentation Project Issues**](https://github.com/Heavy-Division/docs/issues){target=new}
